...
def main():
    """Demonstrate the full tournament system integration."""
    ...
    fire_dragon = TournamentCard(
        name="Fire Dragon", cost=5, rarity="Legendary", id="dragon_001"
    )
    ice_wizard = TournamentCard(
        name="Ice Wizard", cost=4, rarity="Epic", id="wizard_001"
    )
